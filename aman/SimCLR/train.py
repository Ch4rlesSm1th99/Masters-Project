...
def parse_args():
    ...
    parser.add_argument('--train_h5_file_path', type=str,
                        default=r"C:\Users\aman\Desktop\MPhys Data\Data\train.h5",
                        help='Path to training H5 file.')
    parser.add_argument('--val_h5_file_path', type=str,
                        default=r"C:\Users\aman\Desktop\MPhys Data\Data\val.h5",
    ...
    # aug params
    parser.add_argument('--noise_strength', type=float, default=1, help='Noise strength for augmentations.')
